          ...
          <div>
            ...
            <div className="flex flex-col gap-8">
              {experiences.map((exp, index) => (
                ...
                >
                  <div className="absolute top-8 left-0 w-1 h-12 bg-[#a78bfa] rounded-r" />
                  <div className="flex flex-col gap-4">
                    <div className="flex items-start justify-between flex-wrap gap-2">
                      <div>
                        <h3 className="text-white font-medium text-xl">{exp.role}</h3>
                        <div className="flex items-center gap-2 text-[#a78bfa] text-sm mt-1">
                          <Building2 size={14} />
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-[#a78bfa]/10 text-[#a78bfa] rounded-xl">
                    <Link2 size={20} />
                  </div>
                  ...
                  <span className="text-[#a78bfa] text-sm font-medium flex-shrink-0">{cert.year}</span>
                </div>
              ))}
            </div>
          </div>
